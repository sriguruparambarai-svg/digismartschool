...
(function(){
  ...
  {id:"clothes", title:"Clothes",
   l1:["shirt|shirt","pant|pants","dress|dress","shoes|shoe","socks|sock","cap|hat","uniform|uniform","saree|saree","tie|tie","belt|belt"],
   l2:["white shirt|shirt","blue pant|pants","new dress|dress","black shoes|shoe","my socks|sock","red cap|hat","school uniform|uniform","silk saree|saree"],
   l3:["I wear a shirt.|shirt","These are my shoes.|shoe","My dress is new.|dress","I wear a cap.|hat","My mother wears a saree.|saree","I wear my uniform.|uniform","Put on your socks.|sock","I tie my shoes.|shoe"],
   l4:["I wear my uniform to school.|uniform","My mother wears a silk saree to the temple.|saree","I wear a new dress for Deepavali.|dress","Please take off your shoes outside.|shoe","I wear a cap when it is hot.|hat","My tie is blue and white.|tie"],
